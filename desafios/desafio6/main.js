...
//menu 1
let opcionA=prompt(`Gracias Agente ${saludo1}. Indique la accion deseada:

A. Ver el listado actual
...
arrayPersonas.push(new personas(nombreNuevo, apellidoNuevo, edadNueva, nacionalidadNueva, estadoNuevo))
    // console.log(`Lista Actual: </br>${listadoActual}</br>Nueva persona agregada: ${arrayPersonas}`)
